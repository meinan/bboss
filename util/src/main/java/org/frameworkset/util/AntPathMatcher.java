...
public class AntPathMatcher implements PathMatcher{
	...
	protected boolean doMatch(String pattern, String path, boolean fullMatch) {
		...
		String[] pattDirs = SimpleStringUtil.tokenizeToStringArray(pattern, this.pathSeparator);
		String[] pathDirs = SimpleStringUtil.tokenizeToStringArray(path, this.pathSeparator);
	...
	public String extractPathWithinPattern(String pattern, String path) {
		String[] patternParts = SimpleStringUtil.tokenizeToStringArray(pattern, this.pathSeparator);
		String[] pathParts = SimpleStringUtil.tokenizeToStringArray(path, this.pathSeparator);
