...
/**
 * <p>Title: GenericCollectionTypeResolver.java</p> 
 * <p>Description: </p>
 * <p>bboss workgroup</p>
...
public abstract class GenericCollectionTypeResolver {
	...
	private static Class extractType(
		...
		if (type instanceof TypeVariable && methodParam != null && methodParam.getTypeVariableMap() != null) {
			Type mappedType = (Type) methodParam.getTypeVariableMap().get(type);
			if (mappedType != null) {
	...
	private static Class extractTypeFromParameterizedType(MethodParameter methodParam,
		...
		if (paramType instanceof TypeVariable && methodParam != null && methodParam.getTypeVariableMap() != null) {
			Type mappedType = (Type) methodParam.getTypeVariableMap().get(paramType);
			if (mappedType != null) {
