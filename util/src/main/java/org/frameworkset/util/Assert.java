...
public abstract class Assert {
	...
	public static void hasLength(String text, String message) {
		if (!com.frameworkset.util.SimpleStringUtil.hasLength(text)) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void hasText(String text, String message) {
		if (!com.frameworkset.util.SimpleStringUtil.hasText(text)) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if (com.frameworkset.util.SimpleStringUtil.hasLength(textToSearch) && com.frameworkset.util.SimpleStringUtil.hasLength(substring) &&
