...
<html>
	<head>
		<title>SWFUpload-闄愬埗鏈€澶?M鐨勫崟涓枃浠?/title>
		<link
	    ...
	    //alert("瀵逛笉璧凤紝鏈嶅姟鍣ㄧ┖闂存湁闄愶紝鍏抽棴闄勪欢涓婁紶鍔熻兘銆?)
	...
	<form id="form1" action="" method="post"
		...
		<div id="mainBody">
			<ul class="options">
				...
				<li id="size">
					<a id="spanButtonPlaceHolder" >娴忚</a>
				</li>
				<li id="size">
					<a id="upload" href="#" onclick="upStart()">涓婁紶</a>
				</li>


				<li id="abbreviations">
					<a href="#" onclick="swfu.cancelQueue()">鍙栨秷涓婁紶</a>
				</li>
		...
		<div id="mainBody">
			...
			<ul class="options">
				...
				<li id="abbreviations">
					<a href="#" onclick="deleteOpera()">鍒犻櫎</a>
				</li>
			</ul>
