			...
			<tr>
				<td colspan="2">
					<div style="width:100%;height:25px;">
						宸ュ叿鏍?
						<a class="easyui-linkbutton" icon="icon-button_up" href="javascript:void(0)" onclick="document.forms[0].reset();">璋冨彸</a>
						<a class="easyui-linkbutton" icon="icon-button_down" href="javascript:void(0)" onclick="document.forms[0].reset();">璋冨乏</a>
						<a class="easyui-linkbutton" icon="icon-button_left" href="javascript:void(0)" onclick="document.forms[0].reset();">璋冧笂</a>
						<a class="easyui-linkbutton" icon="icon-button_right" href="javascript:void(0)" onclick="document.forms[0].reset();">璋冧笅</a>
						<a class="easyui-linkbutton" icon="icon-add" href="javascript:void(0)" onclick="document.forms[0].reset();">娣诲姞</a>
						<a class="easyui-linkbutton" icon="icon-no" href="javascript:void(0)" onclick="document.forms[0].reset();">鍒犻櫎</a>
					</div>
				</td>
			</tr>
			<tr>
