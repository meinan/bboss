...
<%@ include file="/include/css.jsp"%>
	...
	<% 
		if(Utils.clusterstarted()){
			...
			if(poolMap == null){
				out.println("鑾峰彇闆嗙兢涓瘡鍙版湇鍔″櫒鐨勬暟鎹簱閾炬帴姹犻厤缃俊鎭紓甯竳~~路");
				return;
			}
			//Set serversinfo = poolMap.entrySet();
			//System.out.println("鍚姩鐨勬湇鍔″櫒涓暟 = " + serversinfo.size());
