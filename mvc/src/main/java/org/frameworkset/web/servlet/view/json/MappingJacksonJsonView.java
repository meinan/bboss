...
package org.frameworkset.web.servlet.view.json;
...
/**
 * Bboss-MVC {@link View} that renders JSON content by serializing the model for the current request using <a
 ...
 * @see converter.json.MappingJacksonHttpMessageConverter
 * @since 3.0
 */
