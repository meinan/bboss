...
import org.frameworkset.ui.freemarker.FreeMarkerConfigurationFactory;
 ...
 *
 * <pre>
 * &lt;bean id="freemarkerConfig" class="org.frameworkset.web.servlet.view.freemarker.FreeMarkerConfigurer"&gt;
 *   &lt;property name="templateLoaderPath"&gt;&lt;value&gt;/WEB-INF/freemarker/&lt;/value>&lt;/property&gt;
 * &lt;/bean&gt;</pre>
 *
 * This bean must be included in the application context of any application
 * using Bboss's FreeMarkerView for web MVC. It exists purely to configure FreeMarker.
 ...
 * reference the "bboss.ftl" macro library (contained in this package and thus
 * in bboss.jar) like this:
 *
 * <pre>
 * &lt;#import "bboss.ftl" as bboss/&gt;
 * &lt;@bboss.bind "person.age"/&gt;
 * age is ${bboss.status.value}</pre>
 *
 * Note: Bboss's FreeMarker support requires FreeMarker 2.3 or higher.
 *
 ...
 * @see org.frameworkset.ui.freemarker.FreeMarkerConfigurationFactoryBean
 * @see FreeMarkerView
 */
public class FreeMarkerConfigurer extends FreeMarkerConfigurationFactory
	 ...
	 * <p>Sets up a ClassTemplateLoader to use for loading bboss macros.
	 ...
	 * for the bboss-provided macros, added to the end of the list.
	 */
	@Override
	protected void postProcessTemplateLoaders(List<TemplateLoader> templateLoaders) {
		templateLoaders.add(new ClassTemplateLoader(FreeMarkerConfigurer.class, ""));
		logger.info("ClassTemplateLoader for bboss macros added to FreeMarker configuration");
	}
