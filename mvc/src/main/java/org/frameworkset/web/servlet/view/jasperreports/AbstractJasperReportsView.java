...
import org.frameworkset.ui.jasperreports.JasperReportsUtils;
 ...
 *
 * <p>Response headers can be controlled via the <code>headers</code> property. Bboss
...
public abstract class AbstractJasperReportsView extends AbstractUrlBasedView {
	 ...
	 * data source objects for use in sub-reports. Bboss will convert these objects
	...
	protected void renderMergedOutputModel(
		...
		// Expose Bboss-managed Locale and MessageSource.
	...
	/**
	 * Expose current Bboss-managed Locale and MessageSource to JasperReports i18n
	 ...
	 * @see org.frameworkset.ui.jasperreports.JasperReportsUtils#convertReportData
	 * @see net.sf.jasperreports.engine.JRDataSource
