...
package org.frameworkset.web.servlet.view.document;
 ...
 * Compatible with Apache POI 3.0 as well as 3.5, as of bboss.
 *
 * <p>Properties:
 * <ul>
 ...
 * 	 HSSFSheet sheet = workbook.createSheet("Bboss");
 * 	 sheet.setDefaultColumnWidth(12);
 *
 *   // Write a text at A1.
 *   HSSFCell cell = getCell(sheet, 0, 0);
 *   setText(cell, "Bboss POI test");
 *
