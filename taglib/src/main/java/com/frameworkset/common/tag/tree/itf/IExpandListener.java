 ...
 *
 */
public interface IExpandListener  extends Serializable{
...
//    public void nodeExpanded(ITreeNode node, ITree tree,boolean needNotifier);
     ...
     * @param node The node that was expanded
     * @param tree The tree this node was expanded in
     * @param curLevel The curLevel that was expanded
     * @param needNotifier The needNotifier that was expanded.
     */
