...
public interface Errors {
	 ...
	 * @param defaultMessage fallback default message
	 */
	void rejectWithErrorArgs(String errorCode, Object[] errorArgs, String defaultMessage);
	...
	void rejectValue(String field, String errorCode, String rejectvalue,String defaultMessage);
	void rejectValue(String field, String errorCode, String[] rejectvalue,String defaultMessage);
	
	void rejectValue(String field, String errorCode, String rejectvalue,Class fieldtype,String defaultMessage);
	void rejectValue(String field, String errorCode, String[] rejectvalue,Class fieldtype,String defaultMessage);
	 ...
	 * @see #getNestedPath()
	 */
	void rejectValueWithErrorArgs(String field, String errorCode, Object[] errorArgs, String defaultMessage);
