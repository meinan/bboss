...
import bboss.org.jgroups.blocks.BasicConnectionTable;
import bboss.org.jgroups.blocks.ConnectionTableNIO;
...
public class TCP_NIO extends BasicTCP implements BasicConnectionTable.Receiver
{
    ...
    * (non-Javadoc)
    *
    * @see bboss.org.jgroups.protocols.TCP#getConnectionTable(long, long)
    */
