...
import bboss.org.jgroups.conf.PropertyConverter;
...
public class ProtocolStack extends Protocol implements Transport {
    ...
    /**
     * @deprecated Use {@link bboss.org.jgroups.stack.Protocol#getThreadFactory()}  instead
     * @return
     */
    ...
    /**
     * @deprecated Use {@link TP#setTimerThreadFactory(bboss.org.jgroups.util.ThreadFactory)} instead
     * @param f
     */
    ...
    /**
     * @deprecated Use {@link bboss.org.jgroups.protocols.TP#getTimer()} to fetch the timer and call getCorePoolSize() directly
     * @return
     */
    ...
    /**
     * @deprecated Use {@link bboss.org.jgroups.protocols.TP#getTimer()} instead to fetch the timer from the
