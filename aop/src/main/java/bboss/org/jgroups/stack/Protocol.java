 ...
 * a protocol stack. <a href=bboss.org.jgroups.Event.html>Events</a> are passed from lower
...
public abstract class Protocol {
    ...
    /**
     * Sets a SocketFactory. Socket factories are typically provided by the transport ({@link bboss.org.jgroups.protocols.TP})
     * or {@link bboss.org.jgroups.protocols.TP.ProtocolAdapter}
     * @param factory
     */
    ...
    /**
     * This method is called on a {@link bboss.org.jgroups.Channel#connect(String)}. Starts work.
     ...
     *                      to fail, so {@link bboss.org.jgroups.Channel#connect(String)} will throw an exception
     */
    public void start() throws Exception {
    }

    /**
     * This method is called on a {@link bboss.org.jgroups.Channel#disconnect()}. Stops work (e.g. by closing multicast socket).
    ...
    /**
     * This method is called on a {@link bboss.org.jgroups.Channel#close()}.
