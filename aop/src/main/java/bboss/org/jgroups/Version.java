...
import bboss.org.jgroups.annotations.Immutable;
 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.100 2010/05/10 11:55:21 belaban Exp $
...
public class Version {
    ...
    public static final String description="2.10.0.CR1";

    public static final short version=encode(major, minor, micro);
    public static final String string_version=print(version);
    public static final String cvs="$Id: Version.java,v 1.100 2010/05/10 11:55:21 belaban Exp $";
