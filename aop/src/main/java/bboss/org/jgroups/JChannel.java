 ...
 * {@link bboss.org.jgroups.protocols} package.
 * <p>
 * Note that only the base name has to be given, not the fully specified
 * class name (e.g., UDP instead of bboss.org.jgroups.protocols.UDP).
 * <p>
 ...
 * Property UDP refers to a class {@link bboss.org.jgroups.protocols.UDP},
...
public class JChannel extends Channel {
     ...
     * use {@link #getState(bboss.org.jgroups.Address, long)} instead
     */
     ...
     */
     public Address getLocalPhysicalAddress(Address uuid)
     {
     	return (IpAddress)this.downcall(new Event(Event.GET_PHYSICAL_ADDRESS,uuid));
//     	return (IpAddress)this.prot_stack.getBottomProtocol().down(new Event(Event.GET_PHYSICAL_ADDRESS,uuid));
     }
//     
...
//      */
// 	public Map<UUID,Address> getAllLocalPhysicalAddress()
//     {
//     	Map<UUID,Address> da = (Map<UUID,Address>)this.downcall(new Event(Event.GET_LOGICAL_PHYSICAL_MAPPINGS));
//     	return da;
//
//     }
