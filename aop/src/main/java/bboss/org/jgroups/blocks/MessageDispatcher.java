...
public class MessageDispatcher implements RequestHandler {
    ...
    @Deprecated
    /**
     * @deprecated Use {@link #castMessage(java.util.Collection, bboss.org.jgroups.Message, RequestOptions)} instead
     */
    public RspList castMessage(final Vector dests, Message msg, int mode, long timeout, boolean use_anycasting,
                               RspFilter filter) {
     ...
     * @param options A set of options that govern the call. See {@link bboss.org.jgroups.blocks.RequestOptions} for details
     * @return
     * @since 2.9
     */
     ...
     * must be non-zero !
     * @deprecated Use {@link #sendMessage(bboss.org.jgroups.Message, RequestOptions)} instead
     */
    @Deprecated
