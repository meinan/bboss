...
import bboss.org.jgroups.blocks.DistributedQueue;


/**
 * Uses the DistributedQueue building block. The latter subclasses bboss.org.jgroups.util.Queue and overrides
